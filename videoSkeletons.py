...
def get_angles_video(poseEstimator, video_name):
    if not video_name.endswith(".avi"):
        video_name = video_name + ".avi"
    cap = cv2.VideoCapture("cropped_vids/{}".format(video_name))
...
if __name__ == "__main__":
    ...
    file_video_angles = "23_waving_flipped.pkl"
...
#    video_names = ["short_S001C001P005R002A023_rgb", "short_S001C003P004R001A023_rgb"]
    video_names = os.listdir("cropped_vids")
    ...
    for video_name in video_names:
        ...
        if video_name in angles_per_video:
            ...
            continue
        angles_matrix = get_angles_video(poseEstimator, video_name)
